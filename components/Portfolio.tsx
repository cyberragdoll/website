...
This gallery features a small selection of my favourite works. Follow my social channels to explore my full portfolio.
      ...
      {selectedArt && (
        <div className="fixed inset-0 z-[110] flex flex-col items-center justify-center p-4 md:p-8 animate-in fade-in duration-300">
          ...
          <button onClick={closeModal} className="fixed top-1 right-6 md:top-10 md:right-10 p-4 text-white/40 hover:text-white transition-all z-[120]" aria-label="Close">
