  ...
  const timelineEntries = [
    {
      ...
      description: "Magna Cum Laude (78%). Building a strong foundation in languages, culture, and literary analysis."
    },
    {
      period: "2012 — 2013 @ Faculty of Arts (KU Leuven)",
      title: "MA in Linguistics (Computational & Variational Linguistics)",
      description: "Magna Cum Laude (84%). Bridging linguistic theory with computational methods and research."
    },
    {
      period: "2013 — 2014 @ Department of Computer Science (KU Leuven)",
      title: "MA in Artificial Intelligence (Speech & Language Technology)",
      description: "Summa Cum Laude (85.5%). From theory to practice in modern language-focused AI systems."
    },
    {
