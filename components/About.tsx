  ...
  const lifeInterests = [
    {
      ...
      text: "I'm currently writing and illustrating a fun, accessible book about AI for kids aged 10-12. Think curious robots, colourful illustrations, and big ideas made simple!",
      color: "text-rose-600",
