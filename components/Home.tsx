    ...
    <div className="space-y-12 lg:space-y-16 animate-in fade-in duration-700">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 lg:gap-x-24 gap-y-12 lg:gap-y-0 items-start">
        ...
        <div className="lg:col-span-7 space-y-8">
          ...
          I'm Dr. Leen Sevens, a Belgian computational linguist working in educational technology within the Humanities and Social Sciences Group at KU Leuven. My work explores educational innovation in higher education, with a strong focus on how technology can be used responsibly, creatively, and in a human-centered way. I'm also an artist, translating curiosity into drawings when language runs out. :)
          </p>
