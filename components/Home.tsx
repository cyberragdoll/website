    ...
    <div className="space-y-12 lg:space-y-16 animate-in fade-in duration-700">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 lg:gap-x-24 gap-y-12 lg:gap-y-0 items-start">
        ...
        <div className="lg:col-span-7 space-y-8">
          ...
          <p className="mt-8 text-sm md:text-[1.1rem] text-slate-600 leading-relaxed max-w-full border-l-2 border-sky-400 pl-6 text-left mx-auto lg:mx-0">
          I'm Dr. Leen Sevens, a Belgian computational linguist working in educational technology within the Humanities and Social Sciences Group at KU Leuven. My work explores educational innovation in higher education, with a strong focus on how AI can meaningfully support learning, teaching, and assessment in responsible and human-centered ways. I'm also an artist, translating everyday curiosity into drawings when language runs out. :)
          </p>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8 pb-12">
        ...
        <div className="group p-8 bg-white border border-slate-100 rounded-3xl shadow-sm hover:shadow-xl hover:border-amber-100 transition-all duration-500">
          <h3 className="text-xl font-serif font-bold text-amber-600 mb-4 whitespace-nowrap overflow-hidden text-ellipsis text-center">Science<br />Outreach</h3>
          <p className="text-slate-600 text-sm leading-relaxed text-left">
